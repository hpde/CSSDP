[![SPASE Monthly Validation](https://github.com/hpde/CSSDP/actions/workflows/validate-schedule.yml/badge.svg)](https://github.com/hpde/CSSDP/actions/workflows/validate-schedule.yml)
